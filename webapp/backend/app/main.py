...
from .api import help_api, library, llm, logs, movies, rag, search, server, system, workflows
...
async def root():
    """Root endpoint."""
    return {"message": "PlexMCP Webapp API", "version": settings.API_VERSION, "docs": "/docs"}
