...
4. Start the server:
   ...
   uv run uvicorn plex_mcp.server:app --port 10740
   ```
...
5. Open `http://localhost:10740` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/plex-mcp/issues) |
