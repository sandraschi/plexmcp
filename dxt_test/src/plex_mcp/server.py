...
def main():
    ...
    # Create FastMCP instance with all registered tools
    mcp = FastMCP(
        name="PlexMCP",
        version="2.1.0",
    ...
    # Register all tools from the global scope that are FastMCP tools
    for name, obj in globals().items():
        if hasattr(obj, '_fastmcp_tool') and obj._fastmcp_tool:
