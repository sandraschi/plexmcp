...
class MediaItem(BaseModel):
    ...
    content_rating: Optional[str] = Field(None, description="Content rating (e.g., 'TV-MA', 'PG-13')")
    ...
    # Dates
    added_at: Optional[float] = Field(None, description="Timestamp when the item was added to the library")
    updated_at: Optional[float] = Field(None, description="Timestamp when the item was last updated")
    originally_available_at: Optional[float] = Field(None, description="Original release date as timestamp")
    last_viewed_at: Optional[float] = Field(None, description="Timestamp when the item was last viewed")
    ...
    # For movies
    original_title: Optional[str] = Field(None, description="Original title (for non-English movies)")
    
    # For TV shows
    child_count: Optional[int] = Field(None, description="Number of child items (seasons or episodes)")
    ...
    season_episode: Optional[str] = Field(None, description="Formatted season and episode (e.g., 'S01E03')")
    ...
    last_viewed_at: Optional[float] = Field(None, description="When the item was last viewed (timestamp)")
    
    # Additional metadata
    chapter_source: Optional[str] = Field(None, description="Source of chapter information")
    original_title: Optional[str] = Field(None, description="Original title (for non-English content)")
...
class LibrarySection(BaseModel):
    ...
    content_changed_at: Optional[float] = Field(None, description="When the content was last changed")
