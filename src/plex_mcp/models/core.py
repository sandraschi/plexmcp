...
class PlexServerStatus(BaseModel):
    ...
    my_plex_username: str | None = Field(description="MyPlex account username")
...
class MediaItem(BaseModel):
    ...
    summary: str | None = Field(default=None, description="Plot summary")
    rating: float | None = Field(default=None, description="User rating")
    thumb: str | None = Field(default=None, description="Thumbnail URL")
    art: str | None = Field(default=None, description="Background art URL")
