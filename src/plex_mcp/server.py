...
PlexMCP - Industrialized FastMCP 3.2.0 Server for Plex Media Server Management



FastMCP 3.2.0 with sampling, agentic workflows, skills and prompts.
...
# SEP-1577 agentic tools (sample_step + sample); requires FastMCP 3.2.0 sampling
...
def main():
    ...
    Main entry point for PlexMCP server (FastMCP 3.2.0).
    ...
    logger.info("Starting PlexMCP (FastMCP 3.2.0)")
