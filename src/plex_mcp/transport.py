...
Environment Variables:
    ...
    MCP_PORT: Port for HTTP/SSE. Default: 10764 (fleet range 10700+)
...
ENV_PORT = "MCP_PORT"  # default: 10740
...
Environment Variables:
  ...
  {ENV_PORT}         Port number (default: 10740)
...
Examples:
  ...
  # HTTP mode (web apps)
  python -m {server_name.replace("-", "_")} --http --port 10740

  # Via environment
  MCP_TRANSPORT=http MCP_PORT=10740 python -m {server_name.replace("-", "_")}
""",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help=f"Port to listen on (default: ${ENV_PORT} or 10740)",
    )
    parser.add_argument(
        "--path",
        default=None,
