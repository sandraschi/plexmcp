...
class MediaSearchRequest(BaseModel):
    ...
    library_id: Optional[str] = Field(
        None,
        description="Optional library ID to search within a specific library"
    )
    
    # Media type and basic filters
    media_type: Optional[Literal['movie', 'show', 'season', 'episode', 'artist', 'album', 'track', 'photo']] = Field(
        None,
        description="Filter by specific media type"
    )
    title: Optional[str] = Field(
        None,
        description="Filter by title (supports wildcards with * for partial matches)"
    )
    ...
    decade: Optional[int] = Field(
        ...
        ge=1900,
        le=2100,
        description="Filter by decade (e.g., 2020 for 2020s)"
    )
    ...
    # People filters
    actor: Optional[Union[str, List[str]]] = Field(
        None,
        description="Filter by actor name(s)"
    )
    director: Optional[Union[str, List[str]]] = Field(
        None,
        description="Filter by director name(s)"
    )
    ...
    content_rating: Optional[Union[str, List[str]]] = Field(
        None,
        description="Filter by content rating(s) (e.g., 'PG', 'R', 'TV-MA')"
    )
    studio: Optional[Union[str, List[str]]] = Field(
        None,
        description="Filter by studio(s)"
    )
    country: Optional[Union[str, List[str]]] = Field(
        None,
        description="Filter by country/countries of origin"
    )
    language: Optional[Union[str, List[str]]] = Field(
        None,
        description="Filter by language code(s) (e.g., 'en', 'ja', 'es')"
    )
    collection: Optional[Union[str, List[str]]] = Field(
        None,
        description="Filter by collection name(s)"
    )
    ...
    # Status filters
    unwatched: Optional[bool] = Field(
        None,
        description="If True, only return unwatched items"
    )
    
    # Sorting
    sort_by: Optional[Literal[
        'titleSort', 'title', 'year', 'rating', 'audienceRating', 
        'viewCount', 'lastViewedAt', 'addedAt', 'updatedAt', 
        'duration', 'mediaHeight', 'mediaWidth', 'mediaBitrate'
    ]] = Field(
        'titleSort',
