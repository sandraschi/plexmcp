...
from typing import Any, Dict, List, Optional, TypeVar, Generic, Type, Callable, Coroutine, Union
...
def service_method(
    ...
    """
    def decorator(method: Callable[..., Coroutine[Any, Any, R]]) -> Callable[..., Coroutine[Any, Any, R]]:
        @wraps(method)
